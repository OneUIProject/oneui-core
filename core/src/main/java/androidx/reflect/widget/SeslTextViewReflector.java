...
/**
 * Samsung TextView utility class.
 */
public class SeslTextViewReflector {
    ...
    /**
     * Returns <b>TextView.SEM_AUTOFILL_ID</b>.
     */
    ...
    /**
     * Returns the <var>mSingleLine</var> field value in the given {@link TextView}.
     */
    ...
    /**
     * Returns <b>MultiSelection.getIsMultiSelectingText()</b>.
     */
    ...
    /**
     * Returns <b>MultiSelection.isTextViewHovered()</b>.
     */
    ...
    /**
     * Set whether button highlight in the gìven <arg>textView</arg> is enabled.
     */
    ...
    /**
     * Set whether button highlight with custom color in the gìven <arg>textView</arg> is enabled.
     */
