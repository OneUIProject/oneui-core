...
/**
 * Samsung CollapsingToolbarLayout class.
 */
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            isTitleCustom =
                    a.getBoolean(
                            R.styleable.CollapsingToolbarLayout_Layout_isCustomTitle, false);
            a.recycle();
        }
    ...
    private void updateTitleLayout() {
        ...
        if (mTitleEnabled) {
            TypedArray a
                    = getContext().obtainStyledAttributes(mExtendTitleAppearance, R.styleable.TextAppearance);
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout layout, int verticalOffset) {
            ...
            if (mTitleEnabled) {
                ...
                final float alphaRange = getHeight() * 0.17999999f;
