...
class SeslSeekBarDialogPreference extends DialogPreference {
    ...
    public SeslSeekBarDialogPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public SeslSeekBarDialogPreference(Context context, AttributeSet attrs) {
    ...
    protected static SeekBar getSeekBar(View dialogView) {
        return dialogView.findViewById(R.id.seekbar);
    }
}
